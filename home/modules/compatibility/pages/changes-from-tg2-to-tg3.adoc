...
Please see xref:tigergraph-server:system-management:management-with-gadmin.adoc[Managing with gadmin].
...
|To create a token, use the xref:3.10@tigergraph-server:API:built-in-endpoints.adoc#_request_a_token[REST endpoint GET /requesttoken].
...
See also xref:home:compatibility:changes-among-tg3.adoc[Compatibility among TigerGraph 3 versions]
