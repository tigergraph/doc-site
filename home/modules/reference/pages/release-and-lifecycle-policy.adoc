...
:page-aliases: 3.10@tigergraph-server:intro:release-process.adoc
:page-aliases: 3.11@tigergraph-server:intro:release-process.adoc
:page-aliases: 4.1@tigergraph-server:intro:release-process.adoc
:page-aliases: 4.2@tigergraph-server:intro:release-process.adoc
:page-aliases: current@tigergraph-server:intro:release-process.adoc
...
* A Preview release of a new feature version has <maintenance> = 0 and uses a release candidate suffix, e.g. -rc1, -rc2, etc.
* For example, TigerGraph 4.3.0-rc1 is the first release candidate (rc) preview build of TigerGraph 4.3.0. Subsequent builds in the series (e.g., 4.3.0-rc2, 4.3.0-rc3) primarily focus on stabilization, though additional functionality may be incorporated in select circumstances prior to GA.
...
* The Maintenance Releases of a feature version use `<maintenance>` = 2, 3, ... as needed, e.g. `4.3.2` followed by `4.3.3`.
...
.Release Types and Deliverables
