= TigerGraph Documentation [ GSQL Reorg, post-4.1.0]
:navtitle: home
:page-role: home


====
* xref:3.10.1@tigergraph-server:release-notes:index.adoc#_fixed_and_improved_in_3_10_1[TigerGraph Server 3.10.1]-  was released on May 7th, 2024.
...
xref:3.10.1@tigergraph-server:getting-started:index.adoc[Get Started]
