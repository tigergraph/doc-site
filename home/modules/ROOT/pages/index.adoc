...
[NOTE]
====
* xref:tigergraph-server:release-notes:index.adoc#_fixed_and_improved_in_3_9_3_3[TigerGraph 3.9.3-3] was released on Feb. 13th, 2024.
* xref:tigergraph-server:release-notes:index.adoc#_fixed_and_improved_in_3_9_3_2[TigerGraph 3.9.3-2] was released on Jan. 16th, 2024.
